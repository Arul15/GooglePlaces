...
- (void)mapView:(MKMapView *)mapView regionDidChangeAnimated:(BOOL)animated {
    ...
    MKMapPoint northMapPoint = MKMapPointMake(MKMapRectGetHeight(mRect), MKMapRectGetHeight(mRect));
    MKMapPoint southMapPoint = MKMapPointMake(MKMapRectGetHeight(mRect), MKMapRectGetHeight(mRect));


    
    //Set our current distance instance variable.
    currenDist = MKMetersBetweenMapPoints(eastMapPoint, westMapPoint);
    currenDist = MKMetersBetweenMapPoints(northMapPoint, southMapPoint);
